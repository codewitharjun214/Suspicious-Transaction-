...
const URI = process.env.BTC_NEO4J_URI || process.env.NEO4J_URI || "neo4j://127.0.0.1:7687";
const USER = process.env.BTC_NEO4J_USER || process.env.NEO4J_USER || "neo4j";
const PASSWORD = process.env.BTC_NEO4J_PASSWORD || process.env.NEO4J_PASSWORD || "India@7507535622";
const driver = neo4j.driver(URI, neo4j.auth.basic(USER, PASSWORD));
